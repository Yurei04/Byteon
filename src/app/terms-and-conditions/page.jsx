...
export default function TermsAndConditionsPage() {
  return (
    <div className="min-h-svh bg-bg-base bg-[radial-gradient(rgb(var(--text-faint)/0.3)_1px,transparent_1px)] bg-[size:20px_20px] text-text-primary">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="mb-10">
          <Link
            href="/"
            className="flex items-center gap-2 text-sm text-text-muted/70 hover:text-text-secondary transition-colors mb-8"
          >
        ...
        {/* Divider */}
        <div className="border-t border-brand-400/20 mb-10" />

        <div className="space-y-10 text-text-secondary/90 leading-relaxed">
        ...
        <div className="border-t border-brand-400/20 mt-12 pt-8 text-center text-text-faint text-sm">
