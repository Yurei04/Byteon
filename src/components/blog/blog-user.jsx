...
import BlogEditUser from "./blog-edit-user"

export default function MyBlogs({ blogs, onBlogDeleted, onRefresh, onUpdate }) {
  ...
  const handleDelete = async (blogId) => {
    ...
    try {
      ...
      // notify parent
      if (onBlogDeleted) onBlogDeleted(blogId)
    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4">
        {blogs.map((blog) => (
          <Card
            key={blog.id}
            className="group bg-gradient-to-br from-fuchsia-900/20 via-purple-900/20 to-slate-950/20 backdrop-blur-lg border border-fuchsia-500/20 hover:border-fuchsia-400/40 transition-all duration-300 overflow-hidden"
          >
                ...
                <div className="flex-1 space-y-3">
                  <div>
                    ...
                    <p className="text-fuchsia-200/70 line-clamp-2">
                      {blog.des || (blog.content ? blog.content.substring(0, 150) + '...' : '')}
                    </p>
                  </div>
                  ...
                  <div className="flex gap-2 pt-2">
                    ...
                    <div>
                      <button
                        ...
                        className="inline-flex items-center gap-2 px-3 py-1 border border-red-500/30 text-red-200 rounded hover:bg-red-500/20"
