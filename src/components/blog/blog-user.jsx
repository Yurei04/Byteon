    ...
    <div className="grid gap-4">
        {blogs.map((blog) => (
            <Dialog key={blog.id}>
                ...
                <Card  className="group bg-gradient-to-br from-fuchsia-900/20 via-purple-900/20 to-slate-950/20 backdrop-blur-lg border border-fuchsia-500/20 hover:border-fuchsia-400/40 transition-all duration-300 overflow-hidden">
