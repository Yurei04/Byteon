        ...
        <CardContent className="p-6">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-3">
                <Label className="text-fuchsia-100 font-semibold">Author Name</Label>
              ...
              <div className="space-y-3">
                <Label className="text-fuchsia-100 font-semibold">Location/Place</Label>
            ...
            <div className="space-y-3">
              <Label className="text-fuchsia-100 font-semibold">Related Hackathon/Event</Label>
              <Input value={formData.hackathon} onChange={(e) => setFormData({ ...formData, hackathon: e.target.value })}
                className="bg-white/5 border-fuchsia-500/30 text-white placeholder:text-fuchsia-200/40"
