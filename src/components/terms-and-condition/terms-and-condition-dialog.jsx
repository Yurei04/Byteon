    ...
    <Dialog>
      ...
      <DialogContent className="max-w-2xl max-h-[85vh] flex flex-col bg-surface-raised/95 border border-brand-500/30 text-text-primary backdrop-blur-xl rounded-2xl shadow-2xl shadow-brand-900/20 p-0 gap-0 overflow-hidden">
        ...
        <DialogHeader className="flex-shrink-0 px-6 pt-5 pb-4 border-b border-brand-500/20">
          ...
          <DialogTitle className="text-lg font-semibold text-text-primary text-left">Terms of Service</DialogTitle>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          <div className="space-y-7 text-text-secondary/85 leading-relaxed text-sm">
            ...
            <section>
              ...
              <p>Byteon is intended solely for users who are <strong className="text-text-primary">18 years of age or older</strong>. By registering, you represent and warrant that:</p>
            ...
            <section>
              <h2 className="text-sm font-semibold text-text-primary mb-2">3. Account Registration and Security</h2>
            ...
            <section>
              <h2 className="text-sm font-semibold text-text-primary mb-2">4. User Conduct</h2>
            ...
            <section>
              <h2 className="text-sm font-semibold text-text-primary mb-2">5. Content Ownership and License</h2>
            ...
            <section>
              <h2 className="text-sm font-semibold text-text-primary mb-2">6. Organizations</h2>
            ...
            <section>
              <h2 className="text-sm font-semibold text-text-primary mb-2">8. Disclaimer of Warranties</h2>
            ...
            <section>
              <h2 className="text-sm font-semibold text-text-primary mb-2">9. Limitation of Liability</h2>
            ...
            <section>
              <h2 className="text-sm font-semibold text-text-primary mb-2">10. Indemnification</h2>
            ...
            <section>
              <h2 className="text-sm font-semibold text-text-primary mb-2">11. Governing Law</h2>
            ...
            <section>
              <h2 className="text-sm font-semibold text-text-primary mb-2">12. Changes to the Platform</h2>
            ...
            <section>
              <h2 className="text-sm font-semibold text-text-primary mb-2">13. Account Suspension and Termination</h2>
            ...
            <section>
              <h2 className="text-sm font-semibold text-text-primary mb-2">14. Account Deletion and Suspension Policy</h2>
            ...
            <section>
              <h2 className="text-sm font-semibold text-text-primary mb-2">15. Contact Us</h2>
              <p>
