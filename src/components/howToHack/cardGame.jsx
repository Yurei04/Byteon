  ...
  if (showResults) {
    ...
    return (
      <motion.div
        ...
        className="w-full max-w-3xl mx-auto p-4 bg-black/80 border-2 border-fuchsia-500 rounded-xl shadow-2xl max-h-[85vh] overflow-y-auto mb-24"
      >
          ...
          {passed ? (
            <div className="mb-4">
              ...
              >
                ...
                <h2 className="text-3xl font-bold text-green-400 mb-1">Success!</h2>
                <p className="text-base text-green-300">You passed the challenge!</p>
              </motion.div>
            </div>
          ) : (
            <div className="mb-4">
              ...
              >
                ...
                <p className="text-base text-red-300">Too many wrong answers!</p>
              </motion.div>
            </div>
          )}
