    ...
    <Dialog>
      ...
      <DialogContent className="max-w-2xl max-h-[85vh] flex flex-col bg-surface-raised/95 border border-brand-500/30 text-text-primary backdrop-blur-xl rounded-2xl shadow-2xl shadow-brand-900/20 p-0 gap-0 overflow-hidden">
        ...
        <DialogHeader className="flex-shrink-0 px-6 pt-5 pb-4 border-b border-brand-500/20">
          ...
          <DialogTitle className="text-lg font-semibold text-text-primary text-left">Privacy Policy</DialogTitle>
          <p className="text-xs text-text-faint text-left mt-0.5">Last updated: March 2025</p>
        </DialogHeader>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          <div className="space-y-7 text-text-secondary/85 leading-relaxed text-sm">
            ...
            <section>
              <h2 className="text-sm font-semibold text-text-primary mb-2">1. Introduction</h2>
            ...
            <section>
              <h2 className="text-sm font-semibold text-text-primary mb-2">2. Information We Collect</h2>
              <p>We collect the following types of information:</p>
              <ul className="list-disc list-inside mt-2 space-y-1 text-text-secondary/75">
                <li><strong className="text-text-primary">Account information:</strong> Email address, password (stored as a secure hash), name, age, country, and occupation (for individual users), or organization name and description (for organizations).</li>
                <li><strong className="text-text-primary">Profile media:</strong> Profile photos you choose to upload.</li>
                <li><strong className="text-text-primary">Usage data:</strong> Information about how you interact with the platform, including pages visited, content viewed, and actions taken.</li>
                <li><strong className="text-text-primary">Device and technical data:</strong> IP address, browser type, operating system, and other technical identifiers.</li>
              </ul>
            </section>

            <section>
              <h2 className="text-sm font-semibold text-text-primary mb-2">3. How We Use Your Information</h2>
            ...
            <section>
              <h2 className="text-sm font-semibold text-text-primary mb-2">4. Data Storage and Security</h2>
            ...
            <section>
              <h2 className="text-sm font-semibold text-text-primary mb-2">5. Profile Photos</h2>
            ...
            <section>
              <h2 className="text-sm font-semibold text-text-primary mb-2">6. Data Retention</h2>
            ...
            <section>
              <h2 className="text-sm font-semibold text-text-primary mb-2">7. Third-Party Services</h2>
            ...
            <section>
              <h2 className="text-sm font-semibold text-text-primary mb-2">8. Your Rights</h2>
