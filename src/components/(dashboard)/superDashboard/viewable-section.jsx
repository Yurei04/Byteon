      ...
      {options.map(opt => {
        ...
        return (
          <button
            ...
            className="cursor-pointer cursor-pointer   flex items-center gap-1 px-2.5 py-[3px] rounded-full text-[11px] font-medium transition-all"
        ...
        <div className="flex items-center gap-3 mb-4 flex-wrap">
          ...
          <div className="relative flex-1 max-w-xs group">
            ...
            <Input
              ...
              className="pl-9 h-9 cursor-pointer  bg-black/25 border-white/8 hover:border-white/15 focus:border-white/25 text-white text-sm placeholder:text-white/25 rounded-lg focus:ring-0 transition-colors"
            />
          </div>
          <Button size="sm" onClick={fetchAll} disabled={loading} variant="ghost"
            ...
            <div className="flex items-center gap-2 ml-auto">
              <button
                ...
                className="flex cursor-pointer  items-center gap-1.5 px-3 py-1.5 rounded-lg border border-amber-500/25 bg-amber-500/8 text-amber-300/80 text-xs font-medium hover:bg-yellow-500/15 hover:border-yellow-400/40 hover:text-yellow-200 transition-all">
    ...
    >
      ...
      <div className="flex-1 min-w-0 space-y-1">
        ...
        <div className="flex items-center gap-1.5 min-w-0 overflow-hidden">
          {isSuspended ? (
            <span className="text-[10px] cursor-pointer  px-1.5 py-0.5 rounded-full border font-medium shrink-0 flex items-center gap-1 bg-amber-500/10 text-amber-400/80 border-amber-500/20">
      ...
      <ChevronRight
        className="w-3.5 h-3.5 shrink-0 mt-0.5 cursor-pointer "
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex-1 min-w-0 space-y-2.5">
            ...
            <div className="flex flex-wrap items-center gap-2.5">
              ...
              {isSuspended ? (
                <span className="flex cursor-pointer  items-center gap-1 text-[11px] px-2 py-0.5 rounded-full border font-medium bg-amber-500/10 text-amber-300 border-amber-500/20">
