              ...
              <div className="space-y-4 text-sm">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-white/20 text-[11px] leading-relaxed">
                    For audit trail purposes. Leave blank to delete without a reason.
                  </p>
                </div>
              </div>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0 space-y-1">
        ...
        {/* status / theme / description preview */}
        ...
        <div className="px-6 py-5 space-y-6">
          ...
          {type === "blogs" && (
            <>
              ...
              {item.place && (
                <DetailBlock icon={<Globe className="w-3.5 h-3.5" />} label="Place / Venue">
